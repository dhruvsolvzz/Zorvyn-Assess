    ...
    <motion.div ref={ref} className={cn('relative w-full max-w-4xl mx-auto h-full', className)}>
      <div className="absolute -left-4 md:-left-20 top-3">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-border shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? 'var(--background)' : 'rgb(34 197 94)',
              borderColor: scrollYProgress.get() > 0 ? 'var(--border)' : 'rgb(22 163 74)',
            }}
