...
- **Utilities**: [Lenis](https://lenis.darkroom.engineering/), [Zustand](https://github.com/pmndrs/zustand)
...
The project is pre-configured for **Vercel** with optimized routing and performance monitoring.
...
- **Vercel Speed Insights**: Performance monitoring in real-time.
